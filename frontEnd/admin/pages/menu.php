    ...
    <div id="app-sidepanel" class="app-sidepanel">
        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <div class="app-branding">
                <a class="app-logo" href="index.php?pg=homepage"><img class="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo"><span class="logo-text">គ្រឿងសង្ហារិម</span></a>
	  ...
	  <path d="M6 0h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2v-1a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1H4a2 2 0 0 1 2-2z"/>
                            ...
                            <span class="nav-link-text">គ្រប់គ្រងគ្រឿងសង្ហារិម</span>
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                        ...
                        <div id="submenu-11" class="collapse submenu submenu-11" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link" href="index.php?pt=category">ប្រភេទនៃគ្រឿងសង្ហារិម</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="index.php?p=insert_product">បង្កើតព័ត៌មានគ្រឿងសង្ហារិម</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="index.php?p=product">ព័ត៌មានគ្រឿងសង្ហារិម</a></li>
                            </ul>
                        </div>
                    </li><!--//nav-item-->
                    <li class="nav-item has-submenu">
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                        ...
                        <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link" href="index.php?pg=login">Login</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="index.php?pg=signup">Signup</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="index.php?pg=reset-password">Reset password</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="index.php?pg=404">404 page</a></li>
                            </ul>
                        </div>
                    </li><!--//nav-item-->
	  ...
	  <path fill-rule="evenodd" d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/>
                    ...
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link" href="index.php?pg=docs">
						        <span class="nav-icon">
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                        ...
                        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link" href="index.php?pg=notifications">Notifications</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="index.php?pg=account">Account</a></li>
	  ...
	  <path fill-rule="evenodd" d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/>
                    ...
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link" href="index.php?pg=help">
						        <span class="nav-icon">
