        ...
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                ...
                <nav id="orders-table-tab"
                    ...
                    <a class="flex-sm-fill text-sm-center nav-link" id="create_property-tab" data-bs-toggle="tab"
                       href="#create_property" role="tab" aria-controls="create_property" aria-selected="false">កែប្រែអចលនទ្រព្យថ្មី</a>
                ...
                <div class="tab-content" id="orders-table-tab-content">
                    ...
                    <div class="tab-pane fade show active" id="create_property" role="tabpanel"
                         aria-labelledby="create_property-tab">
                        <?php
                                            ...
                                            <div class="app-card app-card-settings shadow-sm p-4">
                                                ...
                                                <div class="app-card-body">
                                                    <form class="settings-form" method="POST"
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label">ជ្រើសរើសប្រភេទអចលនទ្រព្យ<span
                                                                    style="color: red"> *</span></label>
                                                            <select class="form-select " name="sel_property_type"
                                                                    id="sel_property_type" required>
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label">ឈ្មោះអចនលទ្រព្យ<span
                                                                    style="color: red"> *</span></label>
                                                            <input type="text" class="form-control"
                                                                   id="txt_property_name" name="txt_property_name"
                                                                   value="<?= $property_name ?>">
                                                            <?= $msg1; ?>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label class="form-label" name="txt_property_price">តម្លៃអចលនទ្រព្យ<span
                                                                    style="color: red"> *</span></label>
                                                            <input type="text" class="form-control"
                                                                   name="txt_property_price" id="txt_property_price"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" class="form-control" name="img_property"
                                                                   id="img_property" value="">

                                                        </div>

                                                        <div class="mb-3">
                                                            <label class="form-label" name="sel_property_status">ជ្រើសរើសស្ថានភាពអចលនទ្រព្យ<span
                                                                    style="color: red"> *</span></label>
                                                            <select class="form-select" name='sel_property_status'
                                                                    id='sel_property_status' required>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="tar_desc" id="tar_desc" cols="30"
                                                                      ...
                                                                      style="height: 100px"><?= $property_desc ?></textarea>
                                                        </div>

                                                        <button type="submit" name="btnUpdate"
                                                                class="btn app-btn-primary">កែប្រែ
                                                        </button>
                                                    </form>
                                                </div><!--//app-card-body-->
