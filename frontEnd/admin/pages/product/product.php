        ...
        <div class="container-xl">
                            ...
                            <div class="col-auto">
                                <form method="get" class="table-search-form row gx-1 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <select class="form-select w-auto" name='key_property_type'
                                                id="key_property_type">

                                            <option value="">---សូមជ្រើសរើសប្រភេទអចលនទ្រព្យ---</option>
                                            <?php
                                            $sql = mysqli_query($conn, "SELECT * FROM tblproduct ORDER BY proID DESC");
                                    ...
                                    <div class="col-auto ">
                                        <select class="form-select w-auto" name='key_property_status'
                                                id="key_property_status">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="keyinputdata" name='keyinputdata'
                                               class="form-control search-orders" placeholder="Search">
                                    </div>
                                    <div class="col-auto">
                                        <button type="submit" name="btnSearch" class="btn app-btn-secondary">Search
                                        </button>
                                    </div>
                                </form>
            ...
            <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                <a class="flex-sm-fill text-sm-center nav-link active" id="property_type_list-tab" data-bs-toggle="tab"
                   href="#property_type_list" role="tab" aria-controls="orders-all" aria-selected="true">បញ្ជីប្រភេទអចលនទ្រព្យ</a>
                <a class="flex-sm-fill text-sm-center nav-link" id="create_property_type-tab" data-bs-toggle="tab"
                   href="#create_property_type" role="tab" aria-controls="orders-paid" aria-selected="false">បង្កើតប្រភេទអចលនទ្រព្យថ្មី</a>
                        ...
                        <div class="app-card-body">
                            <div class="table-responsive">
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tr>
                                        <th class="cell">#</th>
                                        <th class="cell">រូបភាពគ្រឿងសង្ហារិម</th>
                                        <th class="cell">ឈ្មោះគ្រឿងសង្ហារិម</th>
                                        <th class="cell">តម្លៃគ្រឿងសង្ហារិម</th>
                                        <th class="cell">បរិយាយ</th>
                                        <th class="cell">ប្រភេទគ្រឿងសង្ហារិម</th>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="cell"><img style="width: 50px"
                                                                      src="assets/images/img_uploaded/<?= $row['property_img'] ?>"
                                                                      alt="image"></td>
                                                ...
                                                <td class="cell">
                                                    ...
                                                    <a class="btn btn-primary"
                                                       href="index.php?p=update_property&id=<?= $row[0] ?>"><i
                                                            class="far fa-edit"></i></a>
                                                    <a href="pages/property/delete_property.php?id=<?= $row[0] ?>"
                                                       class="btn btn-danger"
                                                       onclick="return confirm('Are you sur to delete it!')"><i
                                        ...
                                        <div class="app-card app-card-settings shadow-sm p-4">
                                            ...
                                            <div class="app-card-body">
                                                <form class="settings-form" method="POST"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="txt_property_type_kh" class="form-label"
                                                               name="txt_property_type_kh">ឈ្មោះប្រភេទអចលនទ្រព្យជាភាសាខ្មែរ<span
                                                                style="color: red"> *</span></label>
                                                        <input type="text" class="form-control"
                                                               id="txt_property_type_kh" value="" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="txt_property_type_en" class="form-label"
                                                               name="txt_property_type_en">ឈ្មោះប្រភេទអចលនទ្រព្យជាភាសាអង់គ្លេស<span
                                                                style="color: red"> *</span></label>
                                                        <input type="text" class="form-control"
                                                               name="txt_property_type_en" id="txt_property_type_en"
                                                               value="" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tar_property_type_desc"
                                                               class="form-label">បរិយាយ</label>
                                                        <textarea name="tar_property_type_desc"
                                                                  id="tar_property_type_desc" cols="30"
                                                                  rows="3" class="form-control"
                                                                  style="height: 100px"></textarea>
                                                    </div>
                                                    <button type="submit" name="btnSave" class="btn app-btn-primary">
                                                        រក្សាទុក
                                                    </button>
                                                </form>
                                            </div><!--//app-card-body-->
